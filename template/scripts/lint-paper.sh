...
# lint-paper.sh — Run ChkTeX on the publication paper and report findings.
#
# Usage:
...
#              Silent list which adds publication macros to chktex's allowed set.
#
...
#              and does not honour TEXINPUTS. publication uses .latexmkrc TEXINPUTS
...
#              Justification: publication.sty uses $ $ for inline math throughout;
