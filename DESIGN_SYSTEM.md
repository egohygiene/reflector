...
id: reflector-design-system
title: Reflector Design System
...
# Reflector Design System

## Purpose and scope

This document defines reusable semantic language for Reflector's documentation, terminal output, diagrams, reports, sites, and future interactive surfaces. It does not freeze a framework, component library, or final visual identity.
...
The expression should remain scholarly, contemplative, rigorous, and transparent about uncertainty while allowing product-specific identity to vary inside Ego Hygiene's broader family.
