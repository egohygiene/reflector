...
## [0.1.2](https://github.com/egohygiene/reflector/compare/v0.1.1...v0.1.2) (2026-07-15)


### Features

* automate version surface synchronization across publication pipeline ([11cd8cb](https://github.com/egohygiene/reflector/commit/11cd8cb))
