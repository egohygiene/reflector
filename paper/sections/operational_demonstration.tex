...
\begin{center}
Human Goal $\rightarrow$ Scoped Issue Creation $\rightarrow$ Specification Alignment $\rightarrow$ AI-Assisted Execution $\rightarrow$ Artifact Generation $\rightarrow$ Reflective Audit $\rightarrow$ Synchronization Review $\rightarrow$ Recursive Continuation
\end{center}
...
Operationally, each checkpoint asks four questions: what changed, whether the change matches scoped intent, whether it preserves cross-artifact consistency, and what must happen before continuation. This recursive audit loop makes divergence observable early and supports controlled correction before incoherence compounds.
