...
figures:
  ...
  - id: reflector-figure-4
    ...
    state: placeholder
    dimensions: "1600x900"
    title: Reserved synchronization placeholder figure
    description: "Reserved figure slot for a future synchronization and governance diagram."
    alt_text: "Placeholder figure reserved for synchronization and governance layout stabilization."
    sync_notes: "Reserved. Assign to a section and add label and caption before referencing in the paper."
  ...
  - id: reflector-figure-11
    ...
    description: "Reused across the Future Directions section (as ecosystem map) and the Visual Summary section (as systems map). Captions differ per placement."
    alt_text: "Placeholder figure for future directions and visual systems map layout stabilization."
    sync_notes: "Used in two sections with different captions. When replacing, ensure the final figure is appropriate for both contexts or split into two separate figures."
  ...
  - id: reflector-figure-15
    ...
    state: placeholder
    dimensions: "1600x900"
    title: Reserved recursive synchronization placeholder figure
    description: "Reserved figure slot for a future recursive synchronization diagram."
    alt_text: "Placeholder figure reserved for recursive synchronization loops layout stabilization."
    sync_notes: "Reserved. Assign to a section and add label and caption before referencing in the paper."
