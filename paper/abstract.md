...
3. **Recursive auditing systems** that continuously validate system state against defined invariants
...
- Keep the abstract under 250 words for arXiv compatibility
- Ensure it stands alone without references
- Highlight the four core mechanisms clearly
